...
= clf(train_set,qual_train,test_set,qual_test,"logreg")

#Linear Regression as a Classifier
acc_linreg,prec_linreg,rec_linreg,F_mes_linreg,spec_linreg,sens_linreg\
= clf(train_set,qual_train,test_set,qual_test,"linreg")
  
#SVM
acc_svm,prec_svm,rec_svm,F_mes_svm,spec_svm,sens_svm\
= clf(train_set,qual_train,test_set,qual_test,"svm")  

#Naïve Bayesian     
acc_nb,prec_nb,rec_nb,F_mes_nb,spec_nb,sens_nb\
= clf(train_set,qual_train,test_set,qual_test,"nb")   
...
attr_df = pd.DataFrame(data = task_4,
                        index  = index_val,
                        columns = column_val
                        ) 
